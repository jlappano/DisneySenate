...
Senator.find_by(last_name: 'Schumer').disney_character = snow_white
Senator.find_by(last_name: 'Shelby').disney_character = hades
Senator.find_by(last_name: 'Murkowski').disney_character = sultan
Senator.find_by(last_name: 'McCain').disney_character = sultan
Senator.find_by(last_name: 'Pryor').disney_character = sultan
Senator.find_by(last_name: 'Feinstein').disney_character = charlie
Senator.find_by(state: 'CO').disney_character = snow_white
Senator.find_by(last_name: 'Carper').disney_character = charlie
Senator.find_by(last_name: 'Nelson').disney_character = charlie
Senator.find_by(last_name: 'Chambliss').disney_character = scar
Senator.find_by(last_name: 'Schatz').disney_character = snow_white
Senator.find_by(last_name: 'Crapo').disney_character = hades
Senator.find_by(last_name: 'Durbin').disney_character = charlie
Senator.find_by(last_name: 'Grassley').disney_character = hades
Senator.find_by(last_name: 'Coats').disney_character = scar
Senator.find_by(state: 'KS').disney_character = scar
Senator.find_by(last_name: 'McConnell').disney_character = scar
Senator.find_by(last_name: 'Landrieu').disney_character = sultan
Senator.find_by(last_name: 'Mikulski').disney_character = charlie
Senator.find_by(last_name: 'Levin').disney_character = snow_white
Senator.find_by(last_name: 'Klobuchar').disney_character = charlie
Senator.find_by(last_name: 'Cochran').disney_character = scar
Senator.find_by(last_name: 'McCaskill').disney_character = charlie
Senator.find_by(last_name: 'Baucus').disney_character = sultan
Senator.find_by(last_name: 'Reid').disney_character = snow_white
Senator.find_by(state: 'NM').disney_character = snow_white
Senator.find_by(last_name: 'Burr').disney_character = scar
Senator.find_by(last_name: 'Hoeven').disney_character = sultan
Senator.find_by(last_name: 'Brown').disney_character = snow_white
Senator.find_by(last_name: 'Inhofe').disney_character = hades
Senator.find_by(last_name: 'Wyden').disney_character = snow_white
Senator.find_by(last_name: 'Casey').disney_character = snow_white
Senator.find_by(last_name: 'Graham').disney_character = sultan
Senator.find_by(state: 'SD').disney_character = charlie
Senator.find_by(last_name: 'Alexander').disney_character = sultan
Senator.find_by(last_name: 'Cornyn').disney_character = scar
Senator.find_by(last_name: 'Hatch').disney_character = sultan
Senator.find_by(last_name: 'Warner').disney_character = charlie
Senator.find_by(last_name: 'Murray').disney_character = snow_white
Senator.find_by(last_name: 'Rockefeller').disney_character = charlie
Senator.find_by(state: 'WI').disney_character = hades
Senator.find_by(last_name: 'Enzi').disney_character = hades
Senator.find_by(last_name: 'Warren').disney_character = snow_white
Senator.find_by(last_name: 'Leahy').disney_character = snow_white
Senator.find_by(last_name: 'Blumenthal').disney_character = snow_white
Senator.find_by(last_name: 'Shaheen').disney_character = sultan
Senator.find_by(last_name: 'Reed').disney_character = snow_white
Senator.find_by(last_name: 'Johanns').disney_character = scar
Senator.find_by(last_name: 'Collins').disney_character = sultan
Senator.find_by(last_name: 'Menéndez').disney_character = snow_white
